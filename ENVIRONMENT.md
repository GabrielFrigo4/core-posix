# 🏛️ Core POSIX Environment & Baseline

Especificação do ambiente operacional, dependências de sistema e matriz de suporte para a suíte de ferramentas **core-posix**.
